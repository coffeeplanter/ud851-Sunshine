...
public class NotificationUtils {
    ...
    public static final int WEATHER_NOTIFICATION_ID = 2383;

    private static final String WEATHER_FETCHED_NOTIFICATION_CHANNEL_ID = "weather_fetched_notification_channel";
    ...
    public static void notifyUserOfNewWeather(Context context) {
        ...
        if (todayWeatherCursor.moveToFirst()) {
            ...
            NotificationCompat.Builder notificationBuilder =
                    new  NotificationCompat.Builder(context, WEATHER_FETCHED_NOTIFICATION_CHANNEL_ID)
            ...
            PendingIntent detailActivityPendingIntent = taskStackBuilder.getPendingIntent(0, PendingIntent.FLAG_UPDATE_CURRENT);
            ...
            if (notificationManager != null) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    NotificationChannel mChannel = new NotificationChannel(
                            WEATHER_FETCHED_NOTIFICATION_CHANNEL_ID,
                            "weather_fetched_notification_channel",
