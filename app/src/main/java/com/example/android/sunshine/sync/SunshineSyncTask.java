    ...
    synchronized public static void syncWeather(Context context) {
        ...
        try {
            ...
            if (weatherValues != null && weatherValues.length != 0) {
                ...
                boolean oneDaySinceLastNotificationPassed = timeSinceLastNotification > DateUtils.DAY_IN_MILLIS;

                if (areNotificationsEnabled && oneDaySinceLastNotificationPassed) {
